...
/**
 * View component for a GrIdWorldModel. 
 * 
...
/*		if (estado != ESTADO_FIN_JUEGO) {
			...
			int matriz[][] = new int[bufferedImage.getWidth()][bufferedImage.getHeight()];
					
			// This is to charge the green forest image
			...
			// This is to initiate the green forest image
			...
			// This is to move the green forest image
		...
		g.drawImage(fondoFinal.getImage(), 0, 52, this);
*/					
		...
		for(int filas = 0; filas < 8; filas++) {
			for(int cols = 0; cols < 8; cols++) {
				...
				e.setFrame(245 + cols * 42 + 1, 165 + filas * 42 + 1, 39, 39);
				Area a2 = new Area(e);
				a1.subtract(a2);
			}
		}
